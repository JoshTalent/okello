      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center" data-aos="fade-up" data-aos-delay="100">
            <h2><span>Welcome On </span><span class="underlight">OKELLO Studio's Dashboard</span></h2>
            <p>Throuth here you can change everything</p>
            <a href="#" class="btn-get-started">Back To Website<br></a>
          </div>
        </div>
      </div>
