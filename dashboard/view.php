    ...
    <div class="col-xl-3 col-lg-4 col-md-6">
        ...
        <div class="row">
           <div class="row">
                    ...
                    <img src="<?php echo $row['image']?>" class="img-fluid" alt="" style=" width:1024px; height: 400px; ">
                    <div class="gallery-links d-flex align-items-center justify-content-center">
                    <a href="<?php echo $row['image']?>" title="<?php echo $row['title']?>" class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
                    </div>
                </div>
                </div>
           </div>
           <div class="row">
            <a href ="delete.php?delete_id= <?php echo $row['id'];?>" class="btn text-danger ">delete</a>
           </div>
