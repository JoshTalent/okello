        ...
        <?php
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-8 col-lg-9">
              <input name="" type="text" class="form-control" id="currentPassword" readonly value="<?php echo $row['password']?>">
            </div>
          </div>
          ...
          <div class="text-center">
            <button type="submit" class="btn btn-success col-12" name="save">Change Password</button>
          </div>
          <?php } ?>
...
<?php
            ...
            $sql1= "UPDATE `okello` SET `password`='$password'";
