...
<body class="index-page">
  ...
  <div class="row">
    <div class="col-md-12">
      <h5 class="text-success mt-4 text-center ">MY Notifications <i class="bi bi-bell text-white"></i></h5>
    </div>
  </div>
  <div class="cards border-success">
      <?php $sql = "SELECT * FROM `nitify` order by `id` desc";$query = mysqli_query($con , $sql);while( $row = mysqli_fetch_array($query)){?>
        ...
        <div class="card mb-3" style="max-width: 840px;">
            <div class="row g-0">
              <div class="col-md-4">
                <img src="./dashboard/<?php echo $row['image']?>" class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
